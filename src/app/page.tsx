...
// import PiggyMascot from "@/components/mascot/PiggyMascot";
            ...
            <div className="mm-container px-8 py-16 w-full max-w-7xl mx-auto relative">
              ...
              <div className="mm-asymmetric-grid">
                ...
                >
                  ...
                  >
                    <div className="mm-card mm-card-medium card-3d hover-lift h-full">
...
<<<<<<< HEAD
                  ...
                  >
=======
                  <div className="mm-card-colored mm-card-orange mm-card-tall card-3d hover-lift h-full">
>>>>>>> 471727c99516d37720bf4e10d24bca75be13abe2
                    <div className="flex flex-col h-full justify-between">
                      <div>
                      ...
                      <div>
                        <div className="text-6xl font-bold mb-4 number-highlight">
                          <NumericFormat
                            value={dashboardData.monthSpent}
                            displayType="text"
                            thousandSeparator=","
                            prefix="₹"
                            renderText={(value) => <span className="font-mono">{value}</span>}
                          />
                        </div>
...
=======
                ...
                >
                  ...
                  >
                    <div className="mm-card-colored mm-card-green mm-card-wide card-3d hover-lift h-full">
                      <div className="flex items-center justify-between h-full">
                        <div>
                          <div className="text-8xl mb-4">💰</div>
                          <h3 className="text-3xl font-bold mb-2">Monthly Savings</h3>
                          <div className="text-5xl font-bold number-highlight">
                            <NumericFormat
                        ...
                        <div className="text-right">
                          <div className="text-6xl font-bold font-mono number-highlight">{dashboardData.savingsRate}%</div>
...
<<<<<<< HEAD
                  ...
                  >
                    <div className="flex items-center justify-between h-full">
=======
                  <div className="mm-card mm-card-small card-3d hover-lift h-full bg-gradient-to-br from-mm-purple to-mm-lavender text-white">
                    <div className="flex flex-col h-full justify-between">
>>>>>>> 471727c99516d37720bf4e10d24bca75be13abe2
                      <div>
                      ...
                      <div>
                        <div className="text-7xl font-bold font-mono number-highlight">{dashboardData.financialScore}</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  <motion.div
                    ...
                    className="mm-card card-3d hover-lift"
                  >
